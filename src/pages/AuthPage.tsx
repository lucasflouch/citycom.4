          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full pl-6 pr-14 py-5 bg-slate-50 border-2 border-transparent focus:border-indigo-500 rounded-3xl outline-none transition-all font-bold text-slate-700"
                value={password}
